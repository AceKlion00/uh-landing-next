  ...
  return (<section className="py-80">
    <div className="container mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-center">
        <h3 className="text-primary font-light mb-30 md:mb-0">{design.name}</h3>
        <button className="btn btn-primary btn-mini">Choose another design</button>
      </div>

      <div className="flex mt-40">
        <div className="w-full lg:w-5/12 order-2 lg:order-1 mb-30 lg:mb-0">
          ...
          <p className="text-primary text-18 mt-30 text-center md:text-left">Materials</p>
          <div className="grid grid-cols-2 xl:grid-cols-3">
            {design.kitColors.map((color, index) => (<div className="mb-20" key={index}>
              <div className="rounded=lg border-light-300 p-10 shadow-secondary">
                <Image src={color.image} width={120} height={78} alt={color.name} />
