    ...
    <div className="container mx-auto flex flex-col justify-center items-center h-full">
      ...
      <div className="flex-grow-1">
        ...
        <div className="flex flex-col md:flex-row justify-center mt-30 md:mt-60 w-full">
          <Link href="/"><button className="btn btn-primary btn-lg mb-20 md:mb-0 w-full md:w-190">Go to Home Page</button></Link>
          <Link href="/kits"><button className="btn btn-warning btn-lg md:ml-20 w-full md:w-190">Find Your Perfect Kit</button></Link>
        </div>
      </div>
      <p className="text-16 text-light-500 mt-30 text-center">
      ...
      <div className="flex flex-col md:flex-row justify-between py-20 md:py-40 text-10 w-full">
