    ...
    <div className="px-10 sm:px-20 md:px-30 lg:px-40 xl:px-50 pb-50 pt-20">
      <Swiper className="w-full" breakpoints={swiperBreakPoints } spaceBetween={20}>
        {testimonials.map((testimonial, index) => (<SwiperSlide className="flex-grow" key={index}>
          <div
            className="bg-white rounded-lg shadow-primary text-center relative pt-80 px-40 shadow-secondary mt-55">
            <div className="absolute w-full flex justify-center -top-55 left-0">
              <div
                className="w-110 h-110 rounded-full border-4 border-primary-50 bg-primary-50 overflow-hidden relative">
