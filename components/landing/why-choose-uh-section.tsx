  ...
  return (
    <section className="bg-light-50 py-50 lg:py-80">
      <div className="container mx-auto">
        ...
        {whyChooseUh.map((item: { title: string, description: string[], image: string }, index: number) => (
          <div className="mx-auto grid grid-cols-1 lg:grid-cols-2 gap-30 py-60" key={index}>
            ...
            <div className={index % 2 ? 'lg:order-1' : 'lg:order-2'}>
              <div
                ...
                <Image src={item.image} width={640} height={403 } objectFit="cover" layout="responsive" alt={item.title} placeholder="blur" blurDataURL={shimmerUrl} />
              </div>
            </div>
          </div>
        ))}
