    ...
    <div className="container mx-auto">
      <div className="flex flex-col lg:flex-row items-center">
        ...
        <div className="w-full lg:w-1/3 flex justify-center">
          <Link href="/contact-us" passHref><button className="bg-white outline-none focus:outline-none rounded-lg py-20 px-35 text-20 text-primary font-bold focus:ring focus:ring-primary-50 hover:bg-light-75">Get Your Custom Design</button></Link>
        </div>
      </div>
    </div>
  </section>);
