    ...
    <div className="container mx-auto flex justify-between xl:justify-left">
      ...
      <div className={
        ...
        <ul className="flex flex-col xl:flex-row font-medium text-lg xl:text-base pl-8 xl:pl-0">
          ...
          <li className="py-5 nav-link"><Link href="/kits"><a className="relative xl:px-7 xl:py-4">How It Works</a></Link></li>
          <li className="py-5 nav-link"><Link href="/kits"><a className="relative xl:px-7 xl:py-4">Our Story</a></Link></li>
          <li className="py-5 nav-link"><Link href="/kits"><a className="relative xl:px-7 xl:py-4">Contact Us</a></Link></li>
        </ul>
