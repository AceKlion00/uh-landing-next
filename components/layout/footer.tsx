...
export function Footer() {
  return (<footer className="bg-secondary z-10 text-center lg:text-left text-light pt-24 pb-4">
    <div className="container mx-auto">
      <div className="grid lg:grid-cols-3 gap-4">
        <div className="mb-10 lg:mb-0">
          <Link href="/"><a><Image src="/assets/images/logo-green.svg" height={37} width={130} alt="UH logo" /></a></Link>
          <div className="flex flex-col font-medium mt-8 lg:mt-18">
          ...
          <div className="grid lg:grid-cols-4">
            <div>
              ...
              <ul className="flex flex-col">
                ...
                <li className="py-2.5"><Link href="contact-us"><a>Contact Us</a></Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="flex flex-col">
                ...
                <li className="py-2.5"><Link href="how-it-works"><a>How It Works</a></Link></li>
                <li className="py-2.5"><Link href="partners"><a>Partners</a></Link></li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="font-medium mb-1 mt-8">We accept</p>
              <div className="d-flex justify-center lg:justify-start">
                <span className="mr-3"><Image src="/assets/images/payment-method/visa.svg" width={30} height={30} alt="Visa" /></span>
                <span className="mr-3"><Image src="/assets/images/payment-method/mc.svg" width={30} height={30} alt="Mc" /></span>
      ...
      <div className="lg:flex justify-between mt-20 leading-10">
        ...
        <div className="cursor-pointer">
          <u className="mr-1">Privacy Policy</u>,&nbsp;
          <u className="mr-1">Terms & Conditions</u>,&nbsp;
          <u className="mr-1">Refund Policy</u>.
        </div>
      </div>
    </div>
  </footer>);
