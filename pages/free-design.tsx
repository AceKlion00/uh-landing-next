      ...
      <Layout>
        ...
        <section className="py-80">
          <div className="container mx-auto">
            <p className="text-24 text-light-500 text-center max-w-950 mx-auto">Get started with a Hardscape Architect
              to design your patio, walkway, poolscape, retaining wall, or stair project - <span
                className="text-warning">for free</span>.</p>
          </div>
          <HowItWorksSection/>
          <div className="flex justify-center mt-50">
            <button className="btn btn-warning btn-lg w-full sm:w-auto"
                    onClick={consultationService.showConsultationDialog}>Schedule A Free Consultation
            </button>
          </div>
        </section>
        <WhyUhKitsSection/>
