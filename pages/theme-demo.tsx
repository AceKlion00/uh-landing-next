    ...
    <div className="container mx-auto font-poppins">
      ...
      <main>
        <section className="my-5">
          <h1 className="pb-4 text-36 font-medium">Colors</h1>
          <div className="grid grid-cols-3 gap-4">
            <div className="mb-4">
              <h3 className="pb-2 text-24 font-medium text-primary">Primary</h3>
            ...
            <div className="mb-4">
              <h3 className="pb-2 text-24 font-medium text-secondary">Secondary</h3>
            ...
            <div className="mb-4">
              <h3 className="pb-2 text-24 font-medium text-success">Success</h3>
            ...
            <div className="mb-4">
              <h3 className="pb-2 text-24 font-medium text-warning">Warning</h3>
            ...
            <div className="mb-4">
              <h3 className="pb-2 text-24 font-medium text-danger">Danger</h3>
            ...
            <div className="mb-4">
              <h3 className="pb-2 text-24 font-medium text-light">Light</h3>
